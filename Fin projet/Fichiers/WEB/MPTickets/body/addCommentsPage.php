...
<div class="card-comment centerTable centerH">
	<div class="card-header centerH">
		<h1><center>Ajouter un commentaire</center></h1>
		
	</div>

	<!-- Creation du formulaire en format Tableau -->
	<table id="TableAddCom" class="card-body centerH">
		<form id="formlulaire" method="post" action="/MPTickets/BD/addComment.php">
			<tr>
			...
			<tr>
				...
				<td class="TdCol_3"><button class="Bouton Manage-Button" type="submit">Créer Commentaire</button></td>
			</tr>
